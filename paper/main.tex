...
If you naively fit all the data, you get $b = 0.35$, which is way too low (global average is $\sim$1.0). After declustering the catalog (Gardner-Knopoff window) to remove the 2025 aftershock burst, $M_c \approx 4.7$ and $b \approx 1.06$ --- typical for a tectonic region, and the rates used for the probabilistic hazard below.
...
The 475-year PGA (10\% chance of exceedance in 50 years) ranges from $\sim$0.01$g$ to $\sim$1.9$g$ across the dam portfolio, with a mean of 0.30$g$ (declustered rates, $b \approx 1.06$).
35 dams exceed 0.5$g$ at this return period.
